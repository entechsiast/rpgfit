Feature: Consumables
  ...
  Scenario: View available consumables
    ...
    And I have a "Mana Potion" in my inventory
    ...
    And I should see "Mana Potion" in the consumables list
  ...
  Scenario: Use buff scroll to increase stats
    Given I have a "Scroll of Iron Skin" in my inventory
    When I use the "Scroll of Iron Skin"
